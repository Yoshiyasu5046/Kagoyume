...
//            ArrayList<UserDataDTO> buyRecord = ArrayList<>UserDataDAO.getInstance().getBuyRecord(dto);
//            ib.Dto2IbMapping(buyRecord);
//            session.setAttribute("buyRecord", udb);
            
            Log.LogWrite("購買履歴閲覧ページヘ移動しました。");
